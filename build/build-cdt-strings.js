 ...
 */
function createStringsModule(module, uiStringsDeclare, extraCode) {
  return `
...
const str_ = i18n.createIcuMessageFn('node_modules/${module}', UIStrings);
...
// core/lib/deprecations-strings.js
{
  ...
  let generatedDeprecationSourceText = [
    '// auto-generated by build/build-cdt-strings.js\n',
    '/* eslint-disable */\n',
...
export {
  ...
  fs.writeFileSync(outFile, createStringsModule(
    '@paulirish/trace_engine/panels/application/components/BackForwardCacheStrings.js',
    uiStringsDeclare, extraCode));
}
