...
const acceptableTrace = readJson('../fixtures/artifacts/cnn/trace.json.gz', import.meta);
const acceptableDevtoolsLog = readJson('../fixtures/artifacts/cnn/devtoolslog.json.gz', import.meta);
